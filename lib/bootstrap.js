...
export class BulkPull extends EventEmitter {
  constructor(host, port, experimental = false) {
    super()
  ...
  request({ start, end = Buffer.alloc(32), count, ascending = false }) {
    if (ascending && !this.experimental) throw new TypeError("To use the 'ascending' flag, you must enable experimental mode.")
